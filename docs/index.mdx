...
<Note>
**New in v1.11.0** — CDP fully removed, smarter multi-file tracking. Active file now follows your focused Figma tab when multiple projects have the Desktop Bridge plugin open. All error messages and status responses reference only the WebSocket Desktop Bridge.
</Note>
