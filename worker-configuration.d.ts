/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a51cc265f6af1ad945a5d59098fc3284)
// Runtime types generated with workerd@1.20260305.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FigmaConsoleMCPv3";
	}
	interface Env {
		OAUTH_TOKENS: KVNamespace;
		OAUTH_STATE: KVNamespace;
		BROWSER: Fetcher;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").FigmaConsoleMCPv3>;
	}
}
